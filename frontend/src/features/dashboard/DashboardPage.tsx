    ...
    <div className="space-y-8 animate-fade-in" data-testid="dashboard-page">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          {formatDate(new Date())} — Voici l'état de vos opérations terrain.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <Card>
          <CardHeader className="pb-0">
            <div className="text-xs font-bold uppercase tracking-[0.15em] text-muted-foreground">Interventions par mois</div>
          </CardHeader>
          <CardContent className="pt-4">
            <div className="h-64">
              {stats.by_month.length === 0 ? (
                ...
                <ResponsiveContainer>
                  <BarChart data={stats.by_month} margin={{ top: 0, right: 0, left: -20, bottom: 0 }}>
                    ...
                    />
                    <Bar dataKey="count" name="Interventions" fill={CHART_COLORS.primary} radius={[4, 4, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              )}
            </div>
